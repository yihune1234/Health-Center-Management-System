...
async function setupDatabase() {
  ...
  // Create Database
  await connection.query(`CREATE DATABASE IF NOT EXISTS ${process.env.DB_NAME || 'Nedhi'};`);
  await connection.query(`USE ${process.env.DB_NAME || 'Nedhi'};`);
  ...
  CREATE TABLE IF NOT EXISTS clinics (
    ...
    FOREIGN KEY (campus_id) REFERENCES campuses(campus_id) ON DELETE RESTRICT ON UPDATE CASCADE
  );
  ...
  CREATE TABLE IF NOT EXISTS patients (
    ...
    FOREIGN KEY (registered_clinic_id) REFERENCES clinics(clinic_id) ON DELETE SET NULL ON UPDATE CASCADE
  );
  ...
  CREATE TABLE IF NOT EXISTS staff (
    ...
    middle_name VARCHAR(50),
    last_name VARCHAR(50) NOT NULL,
    role ENUM('Admin','HealthAdmin','ClinicManager','Doctor','Nurse','Pharmacist','Receptionist','LabStaff') NOT NULL,
  ...
  -- Default roles
  INSERT IGNORE INTO roles (role_name, permission_level, description) VALUES
  ('Admin',100,'System administrator'),
  ('HealthAdmin',90,'Healthcare operations admin'),
  ('ClinicManager',80,'Manages clinic operations'),
  ('Doctor',70,'Medical provider'),
  ('Nurse',60,'Clinical support'),
  ('Pharmacist',60,'Pharmacy staff'),
  ('Receptionist',40,'Front desk'),
  ('LabStaff',60,'Lab technician');
  ...
  CREATE TABLE IF NOT EXISTS medical_records (
    ...
    FOREIGN KEY (staff_id) REFERENCES staff(staff_id) ON DELETE RESTRICT ON UPDATE CASCADE,
    FOREIGN KEY (clinic_id) REFERENCES clinics(clinic_id) ON DELETE RESTRICT ON UPDATE CASCADE,
    FOREIGN KEY (signed_by) REFERENCES staff(staff_id) ON DELETE SET NULL ON UPDATE CASCADE
  );
  ...
  CREATE TABLE IF NOT EXISTS lab_requests (
    ...
    notes TEXT,
    FOREIGN KEY (patient_id) REFERENCES patients(patient_id) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (doctor_id) REFERENCES staff(staff_id) ON DELETE RESTRICT ON UPDATE CASCADE,
    FOREIGN KEY (clinic_id) REFERENCES clinics(clinic_id) ON DELETE RESTRICT ON UPDATE CASCADE
  );
  ...
  CREATE TABLE IF NOT EXISTS lab_results (
    ...
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (request_id) REFERENCES lab_requests(request_id) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (technician_id) REFERENCES staff(staff_id) ON DELETE SET NULL ON UPDATE CASCADE
  );
  ...
  CREATE TABLE IF NOT EXISTS prescription_items (
    ...
    FOREIGN KEY (medicine_id) REFERENCES pharmacy_inventory(medicine_id) ON DELETE RESTRICT ON UPDATE CASCADE
  );
  ...
  notes TEXT,
  FOREIGN KEY (prescription_id) REFERENCES prescriptions(prescription_id) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (item_id) REFERENCES prescription_items(item_id) ON DELETE SET NULL ON UPDATE CASCADE,
  FOREIGN KEY (medicine_id) REFERENCES pharmacy_inventory(medicine_id) ON DELETE RESTRICT ON UPDATE CASCADE,
  FOREIGN KEY (pharmacist_id) REFERENCES staff(staff_id) ON DELETE RESTRICT ON UPDATE CASCADE
);
  ...
  CREATE TABLE IF NOT EXISTS payments (
    ...
    FOREIGN KEY (cashier_id) REFERENCES staff(staff_id) ON DELETE RESTRICT ON UPDATE CASCADE
  );
  ...
  CREATE TABLE IF NOT EXISTS referrals (
    ...
    FOREIGN KEY (patient_id) REFERENCES patients(patient_id) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (from_clinic_id) REFERENCES clinics(clinic_id) ON DELETE RESTRICT ON UPDATE CASCADE,
    FOREIGN KEY (to_clinic_id) REFERENCES clinics(clinic_id) ON DELETE RESTRICT ON UPDATE CASCADE,
    FOREIGN KEY (referring_doctor_id) REFERENCES staff(staff_id) ON DELETE RESTRICT ON UPDATE CASCADE,
    FOREIGN KEY (receiving_doctor_id) REFERENCES staff(staff_id) ON DELETE SET NULL ON UPDATE CASCADE
  );
